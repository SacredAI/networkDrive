...
class BibStylesConfig(object):
    ...
    abbrvnat = {
        ...
        '@article': '$authors. $title. <i>$journal</i>,{ {$volume:}$pages,'
                    '} $month $year.{ doi: $doi.}{ URL <a href="$url">$url</a>.}{ '
                    '$note.}',
        'cite': '$surname($year)',
        'default': '$authors. <i>$title</i>. $publisher, $year.{ URL <a '
                   'href="$url">$url</a>.}{ $note.}',
    }

    alpha = {

        '@article': '$authors. $title.{ <i>$journal</i>{, {$volume}{($number)}}{: '
                    '$pages}{, $year}.}{ <a href="$url">$url</a>.}{ <a '
                    'href="$filename">$filename</a>.}{ $note.}',
        'cite': '$Sur$YY',
        'default': '$authors. $title.{ <i>$journal</i>,} $year.{ <a '
                   'href="$url">$url</a>.}{ <a href="$filename">$filename</a>.}{ '
                   '$note.}',
    }

    authordate2 = {

        '@article': '$authors. $year. $title. <i>$journal</i>, <b>$volume</b>('
                    '$number), $pages.{ URL <a href="$url">$url</a>.}{ $note.}',
    ...
    default = {
        ...
        '@article': '$authors: “$title”, <i>$journal</i>,{ pp. $pages,} $year.{ '
                    'URL <a href="$url">$url</a>.}{ $note.}',
        '@book': '{$authors: }<i>$title</i>{ ($editor, ed.)}.{{ $publisher,'
                 '} $year.}{ URL <a href="$url">$url</a>.}{ $note.}',
        '@booklet': '$authors: <i>$title</i>.{{ $publisher,} $year.}{ URL <a '
                    'href="$url">$url</a>.}{ $note.}',
        '@conference': '$authors: “$title”, <i>$journal</i>,{ pp. $pages,'
                       '} $year.{ URL <a href="$url">$url</a>.}{ $note.}',
        '@inbook': '$authors: <i>$title</i>.{{ $publisher,} $year.}{ URL <a '
                   'href="$url">$url</a>.}{ $note.}',
        '@incollection': '$authors: <i>$title</i>{ in <i>$booktitle</i>{ ('
                         '$editor, ed.)}}.{{ $publisher,} $year.}{ URL <a '
                         'href="$url">$url</a>.}{ '
                         '$note.}',
        '@inproceedings': '$authors: “$title”, <i>$booktitle</i>,{ pp. $pages,'
                          '} $year.{ URL <a href="$url">$url</a>.}{ $note.}',
        '@manual': '$authors: <i>$title</i>.{{ $publisher,} $year.}{ URL <a '
                   'href="$url">$url</a>.}{ $note.}',
        '@mastersthesis': '$authors: <i>$title</i>.{{ $publisher,} $year.}{ URL '
                          '<a href="$url">$url</a>.}{ $note.}',
        '@misc': '$authors: <i>$title</i>.{{ $publisher,}{ $howpublished,'
                 '} $year.}{ URL <a href="$url">$url</a>.}{ $note.}',
        '@phdthesis': '$authors: <i>$title</i>.{{ $publisher,} $year.}{ URL <a '
                      'href="$url">$url</a>.}{ $note.}',
        '@proceedings': '$authors: “$title”, <i>$journal</i>,{ pp. $pages,'
                        '} $year.{ URL <a href="$url">$url</a>.}{ $note.}',
        '@techreport': '$authors: <i>$title</i>, $year.{ URL <a '
                       'href="$url">$url</a>.}{ $note.}',
        '@unpublished': '$authors: “$title”, <i>$journal</i>, $year.{ URL <a '
                        'href="$url">$url</a>.}{ $note.}',
        'cite': '$index',
        'default': '$authors: <i>$title</i>.{{ $publisher,} $year.}{ URL <a '
                   'href="$url">$url</a>.}{ $note.}',
    ...
    ieeetr = {
        ...
        '@article': '$authors, “$title”, <i>$journal</i>, vol. $volume, '
                    'no. $number, pp. $pages, $year.{ URL <a '
                    'href="$url">$url</a>.}{ $note.}',
        '@book': '$authors, <i>$title</i>. $publisher, $year.{ URL <a '
                 'href="$url">$url</a>.}{ $note.}',
        'cite': '$index',
        'default': '$authors, “$title”. $year.{ URL <a href="$url">$url</a>.}{ '
                   '$note.}',
    }
    ...
    plain = {
        ...
        '@article': '$authors. $title.{ <i>$journal</i>{, {$volume}{($number)}}{'
                    ':$pages}{, $year}.}{ URL <a href="$url">$url</a>.}{ $note.}',
        '@book': '$authors. <i>$title</i>. $publisher,{ $month} $year.{ URL <a '
                 'href="$url">$url</a>.}{ $note.}',
        '@incollection': '$authors. $title.{ In <i>$booktitle</i> {($editor, '
                         'ed.)}.} $publisher,{ $month} $year.{ URL <a '
                         'href="$url">$url</a>.}{ '
                         '$note.}',
        '@inproceedings': '$authors. $title. { <i>$booktitle</i>{, {$volume}{('
                          '$number)}}{:$pages}{, $year}.}{ URL <a '
                          'href="$url">$url</a>.}{ $note.}',
        'cite': '$index',
        'default': '{$authors. }$title.{{ $publisher,} $year.}{ URL <a '
                   'href="$url">$url</a>.}{ $note.}',
    }

    vancouver = {

        '@article': '$authors. $title. <i>$journal</i>, $year{;{<b>$volume</b>}{('
                    '$number)}{:$pages}}.{ URL: <a href="$url">$url</a>.}{ $note.}',
...
class ContainerConfig(object):
    ...
    extracttext = {
        ...
        'cloned': ['', ],
        'extracted': ['PlainLayout', 'TaggedText', 'Align', 'Caption', 'TextFamily',
                      'EmphaticText', 'VersalitasText', 'BarredText', 'SizeText',
                      'ColorText', 'LangLine', 'Formula', 'Bracket', 'RawText',
                      'BibTag', 'FormulaNumber', 'AlphaCommand', 'EmptyCommand',
                      'OneParamFunction', 'SymbolFunction', 'TextFunction',
                      'FontFunction', 'CombiningFunction', 'DecoratingFunction',
                      'FormulaSymbol', 'BracketCommand', 'TeXCode', ],
    }
...
class FormulaConfig(object):
    ...
    hybridfunctions = {
        ...
        '\\binom': ['{$1}{$2}', 'f2{(}f0{f1{$1}f1{$2}}f2{)}', 'span class="binom"',
                    'span class="binomstack"', 'span class="bigsymbol"', ],
        '\\boxed': ['{$1}', 'f0{$1}', 'span class="boxed"', ],
        '\\cfrac': ['[$p!]{$1}{$2}', 'f0{f3{(}f1{$1}f3{)/(}f2{$2}f3{)}}',
                    'span class="fullfraction"', 'span class="numerator align-$p"',
                    'span class="denominator"', 'span class="ignored"', ],
        '\\color': ['{$p!}{$1}', 'f0{$1}', 'span style="color: $p;"', ],
        '\\colorbox': ['{$p!}{$1}', 'f0{$1}',
                       'span class="colorbox" style="background: $p;"', ],
        '\\dbinom': ['{$1}{$2}', '(f0{f1{f2{$1}}f1{f2{ }}f1{f2{$2}}})',
                     'span class="binomial"', 'span class="binomrow"',
                     'span class="binomcell"', ],
        '\\dfrac': ['{$1}{$2}', 'f0{f3{(}f1{$1}f3{)/(}f2{$2}f3{)}}',
                    'span class="fullfraction"', 'span class="numerator"',
                    'span class="denominator"', 'span class="ignored"', ],
        ...
        '\\fcolorbox': ['{$p!}{$q!}{$1}', 'f0{$1}',
                        'span class="boxed" style="border-color: $p; background: '
                        '$q;"', ],
        '\\frac': ['{$1}{$2}', 'f0{f3{(}f1{$1}f3{)/(}f2{$2}f3{)}}',
        ...
        '\\nicefrac': ['{$1}{$2}', 'f0{f1{$1}⁄f2{$2}}', 'span class="fraction"',
                       'sup class="numerator"', 'sub class="denominator"',
                       'span class="ignored"', ],
        '\\parbox': ['[$p!]{$w!}{$1}', 'f0{1}',
                     'div class="Boxed" style="width: $w;"', ],
        '\\raisebox': ['{$p!}{$1}', 'f0{$1.font}',
                       'span class="raisebox" style="vertical-align: $p;"', ],
        '\\renewenvironment': ['{$1!}{$2!}{$3!}', '', ],
        '\\rule': ['[$v!]{$w!}{$h!}', 'f0/',
                   'hr class="line" style="width: $w; height: $h;"', ],
        '\\scriptscriptstyle': ['{$1}', 'f0{$1}',
                                'span class="scriptscriptstyle"', ],
        '\\scriptstyle': ['{$1}', 'f0{$1}', 'span class="scriptstyle"', ],
        '\\sqrt': ['[$0]{$1}', 'f0{f1{$0}f2{√}f4{(}f3{$1}f4{)}}',
                   'span class="sqrt"', 'sup class="root"', 'span class="radical"',
                   'span class="root"', 'span class="ignored"', ],
        '\\stackrel': ['{$1}{$2}', 'f0{f1{$1}f2{$2}}', 'span class="stackrel"',
                       'span class="upstackrel"', 'span class="downstackrel"', ],
        '\\tbinom': ['{$1}{$2}', '(f0{f1{f2{$1}}f1{f2{ }}f1{f2{$2}}})',
                     'span class="binomial"', 'span class="binomrow"',
                     'span class="binomcell"', ],
        ...
        '\\unitfrac': ['[$0]{$1}{$2}', '$0f0{f1{$1.font}⁄f2{$2.font}}',
                       'span class="fraction"', 'sup class="unit"',
                       'sub class="unit"', ],
        '\\uproot': ['{$p!}', 'f0{ }',
...
class HeaderConfig(object):
    ...
    styles = {
        ...
        'article': ['article', 'aastex', 'aapaper', 'acmsiggraph', 'sigplanconf',
                    'achemso', 'amsart', 'apa', 'arab-article', 'armenian-article',
                    'article-beamer', 'chess', 'dtk', 'elsarticle', 'heb-article',
                    'IEEEtran', 'iopart', 'kluwer', 'scrarticle-beamer', 'scrartcl',
                    'extarticle', 'paper', 'mwart', 'revtex4', 'spie', 'svglobal3',
                    'ltugboat', 'agu-dtd', 'jgrga', 'agums', 'entcs', 'egs',
                    'ijmpc', 'ijmpd', 'singlecol-new', 'doublecol-new', 'isprs',
                    'tarticle', 'jsarticle', 'jarticle', 'jss', 'literate-article',
                    'siamltex', 'cl2emult', 'llncs', 'svglobal', 'svjog',
                    'svprobth', ],
        'book': ['book', 'amsbook', 'scrbook', 'extbook', 'tufte-book', 'report',
                 'extreport', 'scrreprt', 'memoir', 'tbook', 'jsbook', 'jbook',
                 'mwbk', 'svmono', 'svmult', 'treport', 'jreport', 'mwrep', ],
    }
...
class ImageConfig(object):
    ...
    converters = {
        ...
        'imagemagick': 'convert[ -density $scale][ -define '
                       '$format:use-cropbox=true] "$input" "$output"',
...
class LayoutConfig(object):
    ...
    groupable = {
        ...
        'allowed': ['StringContainer', 'Constant', 'TaggedText', 'Align',
...
class NumberingConfig(object):
    ...
    layouts = {
        ...
        'ordered': ['Chapter', 'Section', 'Subsection', 'Subsubsection',
                    'Paragraph', ],
        'roman': ['Part', 'Book', ],
    }
...
class TOCConfig(object):
    ...
    extracttitle = {
        ...
        'cloned': ['TextFamily', 'EmphaticText', 'VersalitasText', 'BarredText',
                   'SizeText', 'ColorText', 'LangLine', 'Formula', ],
        'extracted': ['PlainLayout', 'TaggedText', 'Align', 'Caption',
                      'StandardLayout', 'FlexInset', ],
    }
...
class TranslationConfig(object):
    ...
    constants = {
        ...
        'jsmath-requires': ' requires JavaScript to correctly process the '
                           'mathematics on this page. ',
...
class CommandLineParser(object):
    ...
    def readquoted(self, args, initial):
        ...
        Trace.error('Oops')
        value = initial[1:]
        while len(args) > 0 and not args[0].endswith('"') and not args[
            0].startswith('--'):
...
class Options(object):
    ...
    def usage(self):
        "Show correct usage"
        Trace.error('Usage: ' + os.path.basename(
            Options.location) + ' [options] [filein] [fileout]')
    ...
    def showoptions(self):
        ...
        Trace.error(
            '    --debug:                enable debugging messages (for '
            'developers)')
        Trace.error(
        ...
        Trace.error(
            '    --embedcss "file.css":  embed styles from a CSS file into the '
            'output')
        Trace.error(
            '    --favicon "icon.ico":   insert the specified favicon in the '
            'header.')
        Trace.error(
            '    --html:                 output HTML 4.0 instead of the default '
            'XHTML')
        Trace.error('    --unicode:              full Unicode output')
        Trace.error(
            '    --iso885915:            output a document with ISO-8859-15 '
            'encoding')
        Trace.error(
        ...
        Trace.error(
            '    --directory "img_dir":  look for images in the specified '
            'directory')
        Trace.error(
            '    --destdirectory "dest": put converted images into this directory')
        Trace.error(
            '    --imageformat ".ext":   image output format, or "copy" to copy '
            'images')
        Trace.error(
            '    --noconvert:            do not convert images, use in original '
            'locations')
        Trace.error(
            '    --converter "inkscape": use an alternative program to convert '
            'images')
        Trace.error('  Options for footnote display:')
        Trace.error(
            '    --numberfoot:           mark footnotes with numbers instead of '
            'letters')
        Trace.error(
        ...
        Trace.error(
            '    --supfoot:              use superscript for footnote markers ('
            'default)')
        Trace.error(
            '    --alignfoot:            use aligned text for footnote markers')
        Trace.error(
            '    --footnotes "options":  specify several comma-separated '
            'footnotes options')
        Trace.error(
            '      Available options are: "number", "symbol", "hover", "margin", '
            '"end",')
        Trace.error('        "sup", "align"')
        Trace.error('  Advanced output options:')
        Trace.error(
            '    --splitpart "depth":    split the resulting webpage at the given '
            'depth')
        Trace.error(
            '    --tocfor "page":        generate a TOC that points to the given '
            'page')
        Trace.error(
            '    --target "frame":       make all links point to the given frame')
        Trace.error(
            '    --notoclabels:          omit the part labels in the TOC, '
            'such as Chapter')
        Trace.error(
            '    --lowmem:               do the conversion on the fly (conserve '
            'memory)')
        Trace.error(
        ...
        Trace.error(
            '    --mathjax "URL":        use MathJax from the given URL to '
            'display equations')
        Trace.error(
            '    --googlecharts:         use Google Charts to generate formula '
            'images')
        Trace.error(
            '    --template "file":      use a template, put everything in '
            '<!--$content-->')
        Trace.error(
        ...
        Trace.error(
            '    --toctarget "page":     (deprecated) generate a TOC for the '
            'given page')
        Trace.error(
            '    --nocopy:               (deprecated) maintained for backwards '
            'compatibility')
        Trace.error(
            '    --jsmath "URL":         use jsMath from the given URL to display '
            'equations')
        sys.exit()
...
class ContainerExtractor(object):
    ...
    def __init__(self, config):
        "The config parameter is a map containing three lists: allowed,
    ...
    def gethtml(self, container):
        ...
        for element in container.contents:
            if not hasattr(element, 'gethtml'):
                Trace.error('No html in ' + element.__class__.__name__ + ': ' + str(
                    element))
                return html
...
class FilePosition(Position):
    ...
    def isout(self):
        ...
        if self.pos > len(self.reader.currentline()):
            if self.pos > len(self.reader.currentline()) + 1:
                Trace.error(
                    'Out of the line ' + self.reader.currentline() + ': ' + str(
                        self.pos))
            self.nextline()
    ...
    def current(self):
        ...
        if self.pos == len(self.reader.currentline()):
            return '\n'
        if self.pos > len(self.reader.currentline()):
            Trace.error('Out of the line ' + self.reader.currentline() + ': ' + str(
                self.pos))
            return '*'
    ...
    def parseformula(self, reader):
        ...
        if beginbefore in reader.currentline():
            if reader.currentline().strip().endswith(beginafter):
                ...
                return startpiece + self.parsemultiliner(reader, startpiece,
                                                         endpiece) + endpiece
        ...
        if begincommand in reader.currentline() and beginbracket in \
                reader.currentline():
...
class Bracket(FormulaBit):
    ...
    def parsecomplete(self, pos, innerparser):
        ...
        if not pos.checkfor(self.start):
            Trace.error(
                'Bracket should start with ' + self.start + ' at ' +
                pos.identifier())
            return None
...
class Formula(Container):
    ...
    def googlecharts(self):
        ...
        url = FormulaConfig.urls['googlecharts'] + urllib.parse.quote_plus(
            self.parsed)
...
class NumberGenerator(object):
    ...
    def generate(self, type):
        ...
        "Ordered part types return dot-separated tuples: Chapter 5, Subsection " \
        "2.3.5."
...
class ContainerSize(object):
    ...
    def checkvalidheight(self, container):
        ...
        if self.height and self.extractnumber(
                self.height) == '1' and heightspecial == 'totalheight':
            self.height = None
    ...
    def addstyle(self, container):
        ...
        if not self.width and not self.height and not self.maxwidth and not \
                self.maxheight:
...
class FormulaCases(MultiRowFormula):
    ...
    def parsebit(self, pos):
        ...
        array = TaggedBit().complete(self.contents, 'span class="bracketcases"',
                                     True)
...
class CombiningFunction(OneParamFunction):
    ...
    def parsebit(self, pos):
        ...
        if not parameter:
            ...
            Trace.error(
                'Applying combining function ' + self.command + ' to invalid '
                                                                'string "' +
...
class LimitsProcessor(MathsProcessor):
    ...
    def process(self, contents, index):
        ...
        if self.checkscript(contents, index) and self.checkscript(contents,
                                                                  index + 1):
    ...
    def modifyscripts(self, contents, index):
        ...
        scripts = TaggedBit().complete([superscript, subscript],
                                       'span class="scripts"')
...
class ParameterDefinition(object):
    ...
    "Example: [$1]{$p!} reads an optional parameter $1 and a literal mandatory " \
    "parameter p."
        ...
        for variable in self.params:
            if variable in tag:
                ...
                if not param.literal:
                    Trace.error(
                        'Parameters in tag ' + tag + ' should be literal: {' +
                        variable + '!}')
                    continue
...
class MacroParameter(FormulaBit):
    ...
    def parsebit(self, pos):
        ...
        self.contents = [
            TaggedBit().constant('#' + str(self.number), 'span class="unknown"')]
