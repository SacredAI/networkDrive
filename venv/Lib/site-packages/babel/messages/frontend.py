...
from babel.messages.extract import DEFAULT_KEYWORDS, DEFAULT_MAPPING, \
    check_and_call_extract_file, extract_from_dir
...
class extract_messages(Command):
    ...
    user_options = [
        ...
        ('input-paths=', None,
         'files or directories that should be scanned for messages. Separate '
         'multiple '
...
class update_catalog(Command):
    ...
    boolean_options = ['no-wrap', 'ignore-obsolete', 'no-fuzzy-matching',
...
def parse_keywords(strings=[]):
    ...
    >>> kw = sorted(parse_keywords(['_', 'dgettext:2', 'dngettext:2,3',
    'pgettext:1c,2']).items())
