...
def check_and_call_extract_file(filepath, method_map, options_map,
    ...
    """Checks if the given file matches an extraction method mapping, and if so,
...
def extract(method, fileobj, keywords=DEFAULT_KEYWORDS, comment_tags=(),
    ...
    :returns: iterable of tuples of the form ``(lineno, message, comments,
    context)``
...
def extract_javascript(fileobj, keywords, comment_tags, options):
    ...
    for token in tokenize(
        ...
        if (  # Turn keyword`foo` expressions into keyword("foo") calls:
                ...
                (
                        last_token and last_token.type == 'name') and  # we've
                # seen nothing after the keyword...
