...
def extract_operands(source):
    """Extract operands from a decimal, a float or an int, according to `CLDR
    rules`_.
    ...
    .. _`CLDR rules`: http://www.unicode.org/reports/tr35/tr35-33/tr35-numbers
    .html#Operands
