...
# https://docs.microsoft.com/en-us/previous-versions/windows/embedded/ms930130(
# v=msdn.10)
# for more.
chm_locales = {
    # lang:   LCID,  encoding
...
class HTMLHelpBuilder(StandaloneHTMLBuilder):
    ...
    def build_project_file(self) -> None:
        ...
        for root, dirs, files in os.walk(self.outdir):
            ...
            for fn in sorted(files):
                if (in_staticdir and not fn.endswith('.js')) or fn.endswith(
                        '.html'):
        ...
        with open(filename, 'w', encoding=self.encoding,
    ...
    def build_hhx(self, outdir: str, outname: str) -> None:
        ...
        with open(filename, 'w', encoding=self.encoding,
            ...
            def write_index(title: str, refs: List[Tuple[str, str]], subitems: List[
                Tuple[str, List[Tuple[str, str]]]]) -> None:  # NOQA
